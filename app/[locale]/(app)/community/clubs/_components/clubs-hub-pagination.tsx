...
/**
 * Renders ‹ Prev · 1 · 2 · 3 · … · N · Next › for the /clubs hub grid.
 * Returns null when totalPages <= 1. Mirrors NumberedPagination's circle-dot
 * styling but constructs `/${locale}/community/clubs?...` URLs via URLSearchParams.
 */
export function ClubsHubPagination({ locale, page, totalPages, baseParams }: Props) {
  if (totalPages <= 1) return null

  const basePath = `/${locale}/community/clubs`
