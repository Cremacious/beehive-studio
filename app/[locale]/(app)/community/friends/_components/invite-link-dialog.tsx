...
export function InviteLinkDialog({ locale }: Props) {
  ...
  function handleOpenChange(next: boolean) {
    ...
    if (next && !url) {
      ...
      startTransition(async () => {
        ...
        setUrl(`${origin}/${locale}/friend-invite/${r.data.token}`)
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        >
          Anyone who opens this link will be friended with you when they sign in.
        </p>
        {error ? (
          <p
