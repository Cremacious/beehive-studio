...
function ctaHref(
  ...
  switch (variant) {
    ...
    case 'invite-collaborators':
      return opts.hiveId ? `/${locale}/hive/${opts.hiveId}/members` : `/${locale}/community/hives`
    case 'set-word-goal':
      return opts.hiveId ? `/${locale}/hive/${opts.hiveId}/word-goals` : `/${locale}/community/hives`
    case 'try-standalone':
      return `/${locale}/community/hives`
    case 'set-buzz-up':
      return opts.hiveId ? `/${locale}/hive/${opts.hiveId}/buzz` : `/${locale}/community/hives`
  }
}
