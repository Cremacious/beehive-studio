...
/**
 * Renders ‹ Prev · 1 · 2 · 3 · … · N · Next › for the /hives hub grid.
 * Returns null when totalPages <= 1. Mirrors NumberedPagination's circle-dot
 * styling but constructs `/${locale}/community/hives?...` URLs via URLSearchParams.
 */
export function HivesHubPagination({ locale, page, totalPages, baseParams }: Props) {
  if (totalPages <= 1) return null

  const basePath = `/${locale}/community/hives`
