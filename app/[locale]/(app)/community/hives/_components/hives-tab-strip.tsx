 ...
 */
export function HivesTabStrip({ locale, current, counts, baseParams }: Props) {
  const hrefFor = (id: HivesTab): string => {
    ...
    return `/${locale}/community/hives?${sp.toString()}`
  }
