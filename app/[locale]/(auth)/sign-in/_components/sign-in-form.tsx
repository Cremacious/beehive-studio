    ...
    <div className="w-full max-w-md">
      ...
      <div className="paper-stack bg-card rounded-2xl p-8 sm:p-10">
        <div className="mb-7 text-center">
          ...
          <h1 className="mainFont font-bold text-[30px] leading-tight">Welcome back</h1>
          <p className="text-white/60 text-[14.5px] mt-2">Sign in to keep building your hive.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <Link href={`/${locale}/forgot-password`} className="text-[12.5px] text-brand hover:underline underline-offset-4">
                Forgot password?
              </Link>
            </div>
            ...
            <label className="inline-flex items-center gap-2 cursor-pointer select-none">
              ...
              <span
                className={`w-4 h-4 rounded-md border flex items-center justify-center transition-colors ${
                  rememberMe ? 'bg-brand border-brand' : 'bg-[#252525] border-border'
                }`}
              >
                <svg viewBox="0 0 24 24" className={`w-3 h-3 text-black transition-opacity ${rememberMe ? 'opacity-100' : 'opacity-0'}`} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M20 6 9 17l-5-5"/>
                </svg>
              </span>
              <span className="text-[13px] text-white/70">Keep me signed in</span>
            </label>
          </div>
      ...
      <p className="text-center text-[14px] text-white/60 mt-6">
        ...
        <Link href={`/${locale}/sign-up`} className="text-brand font-medium hover:underline underline-offset-4 ml-1">
          Sign up
        </Link>
      </p>
    </div>
